App({
  data: {
    ...
    //分享预览图缓存key
    share_preview_key:"share_preview_key",
    ...
    // 请求地址
    request_url: "https://e.shidawulian.com/",
    // request_url: 'http://tp5-dev.com/',
    // request_url: 'http://192.168.50.213/',

    // 基础信息
    application_title: "搞鲜商城",
    application_describe: "搞鲜商城",
  },
  ...
  */
  ...
  is_req_objData(url, data,method,success,fail){
    let obj ={}
    if((url || null) == null){
      return fail("请求地址有误")
    }
    ...
    wx.request({
      ...
      dataType: "json",
      success: (res) => {
        typeof res&&success(res)
      },fail(){
        typeof res && fail("服务器繁忙")
      }
    })
